...
*/
sim::PlaneCoordinator::PlaneCoordinator()
{
...
*/
bool sim::PlaneCoordinator::goToPoint(struct sim::waypoint receivedPoint, bool isAvoidanceManeuver, bool isNewQueue)
{
	//clear the queues
	if(isNewQueue)
	{
		std::list<struct sim::waypoint> emptyQueue;
...
*/
struct sim::waypoint sim::PlaneCoordinator::getWaypointOfQueue(bool isAvoidanceQueue, int position)
{
	//setup invalid return as default
	struct sim::waypoint ret;
	ret.latitude = -1000;
	ret.longitude = -1000;
	ret.altitude = -1000;
	
	std::list<struct sim::waypoint>::iterator ii;
	int count = 0;
...
*/
sim::Command sim::PlaneCoordinator::getPriorityCommand()
{
	//start with defaults
	sim::Command ret;
	ret.planeID = -1;
...
*/
bool sim::PlaneCoordinator::handleNewUpdate(sim::TelemetryUpdate update, sim::Command *newCommand)
{
