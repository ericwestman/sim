...
sim::SimulatedPlane::SimulatedPlane()
{
	//make a bad ID
	this->planeID = -1;
}
...
*/
sim::SimulatedPlane::SimulatedPlane(long long int planeID, sim::CreateSimulatedPlane::Request &requestFromUser)
{
	//data from inputs
...
*/
bool sim::SimulatedPlane::handleNewCommand(sim::Command newCommand)
{
...
*/
bool sim::SimulatedPlane::fillTelemetryUpdate(sim::TelemetryUpdate *tUpdate)
{
