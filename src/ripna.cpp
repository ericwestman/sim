...
/*	!!!	ORIGINAL - CHANGED FOR ATTEMPT #2	!!!	
...
/////////////////////// * ATTEMPT 2 * ///////////////////////////////
	plane1.setTwoAgoThreatID(plane1.getOneAgoThreatID());
	plane1.setTwoAgoZEM(plane1.getOneAgoZEM());
	plane1.setTwoAgoTgo(plane1.getOneAgoTgo());

	plane1.setOneAgoThreatID(plane1.getCurrentThreatID());
	plane1.setOneAgoZEM(plane1.getCurrentZEM());
	plane1.setOneAgoTgo(plane1.getCurrentTgo());

	plane1.setCurrentThreatID(greatestThreat.planeID);
	plane1.setCurrentZEM(greatestThreat.ZEM);
	plane1.setCurrentTgo(greatestThreat.timeToGo);

	int threatID = plane1.getCurrentThreatID();
	double threatZEM = plane1.getCurrentZEM();
...
/////////////////////////////////////////////////////////////////////
	...
	return calculateWaypoint(plane1, turningRadius, turnRight, 1);
}
